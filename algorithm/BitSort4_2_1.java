...
@MethodName("bitSort4_2_1")
public class BitSort4_2_1 implements SortingAlgorithm {
    ...
    private static final int SEQUENTIAL_THRESHOLD_2 = 600000; // Adjust as needed
    ...
    private class BitSortTask extends RecursiveAction {
        ...
        protected void compute() {
            ...
            if ( SEQUENTIAL_THRESHOLD <= high - low && high - low < SEQUENTIAL_THRESHOLD_2) {
                bitSort4(arr, order, low, high);
                return;
            }
    ...
    private void bitSort4(Long[] arr, int order, int low, int high) {
        if (order < 0 || low >= high) {
            return;
        }
